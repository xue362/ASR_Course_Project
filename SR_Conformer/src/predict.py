...
from SR_Conformer.src.data_utils.audio import AudioSegment
from SR_Conformer.src.data_utils.featurizer.audio_featurizer import AudioFeaturizer
from SR_Conformer.src.data_utils.featurizer.text_featurizer import TextFeaturizer
from SR_Conformer.src.decoders.ctc_greedy_decoder import greedy_decoder, greedy_decoder_chunk
from SR_Conformer.src.infer_utils.inference_predictor import InferencePredictor
from SR_Conformer.src.utils.logger import setup_logger
from SR_Conformer.src.utils.utils import dict_to_object, print_arguments
...
class SRPredictor:
    ...
    def __init_decoder(self):
        ...
        if self.configs.decoder == "ctc_beam_search":
            if platform.system() != 'Windows':
                try:
                    from SR_Conformer.src.decoders.beam_search_decoder import BeamSearchDecoder
    ...
    def predict_long(self,
        ...
        if self.vad_predictor is None:
            from SR_Conformer.src.infer_utils.vad_predictor import VADPredictor
